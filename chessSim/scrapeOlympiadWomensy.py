...
def main():
    ...
    playersURL = 'http://chess-results.com/tnr653632.aspx?lan=1&art=16&flag=30&zeilen=99999'
    ...
    players.to_csv('./chessSim/data/olympiad/playersW2022.csv', index = False)
    # print(players)
    
    #  make teams
    teamURL = 'http://chess-results.com/tnr653632.aspx?lan=1&art=32&turdet=YES&flag=30&zeilen=99999'
    ...
    teams.to_csv('./chessSim/data/olympiad/teamsW2022.csv', index = False)
    ...
    df.to_csv('./chessSim/data/olympiad/gamesW2022.csv', index = False)
    # print(df.columns)

    rounds = ['https://chess-results.com/tnr653632.aspx?lan=1&art=2&rd=1&flag=30',
            'http://chess-results.com/tnr653632.aspx?lan=1&art=2&rd=2&flag=30',
            ...
            'http://chess-results.com/tnr653632.aspx?lan=1&art=2&rd=7&flag=30',
            'http://chess-results.com/tnr653632.aspx?lan=1&art=2&rd=8&flag=30',
            'http://chess-results.com/tnr653632.aspx?lan=1&art=2&rd=9&flag=30',
            'http://chess-results.com/tnr653632.aspx?lan=1&art=2&rd=10&flag=30',
    ...
    matchResults.to_csv('./chessSim/data/olympiad/matchesW2022.csv', index = False)
