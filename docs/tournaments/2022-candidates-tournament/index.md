...
Currently, Caruana is leading the standings for second place, as he is tied with Nakamura for the highest score but Caruana is leading in SB. I have predictions for second place probabilities below the winning chances section.

GM Anish Giri has been posting recaps of each days games, which you can see below for Round 9:

<div class="ttt">
  <iframe width="560" height="315" class="yt" src="https://www.youtube.com/embed/CdLsCIsyZCc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
<br>
**And, now, predictions!**
...
|:---------------|---------:|--------:|-----:|
| Caruana        |     34.9 |     5.5 | 27.8 |
| Ding Liren     |     25.8 |     5.5 | 25.2 |
| Nakamura       |     24.6 |     5.5 | 26.2 |
| Nepomniachtchi |     11.4 |     7.0 | 33.0 |
| Radjabov       |      2.1 |     4.5 | 23.2 |
| Firouzja       |      0.4 |     4.0 | 18.0 |
| Rapport        |      0.4 |     4.0 | 18.5 |
| Duda           |      0.3 |     4.0 | 20.0 |
{: .field .narrow}
<br>
